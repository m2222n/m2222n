...
현재 **Computer Vision & Robotics**를 공부하며 실무에 적용 중입니다.
...
![Cohere](https://img.shields.io/badge/Cohere-Rerank-39594D?style=for-the-badge&logoColor=white)
...
> Formlabs Form 4 프린터 4대 실시간 모니터링 + 원격 제어 웹 플랫폼 + 3D 빈피킹 비전 시스템 + MaixCAM 엣지 AI (1인 풀스택 개발) | [factory.flickdone.com](https://factory.flickdone.com/) 📅 2026.02 ~ 현재
...
- **19개** 신규 크롤러 개발 (2주), **41개** 소스 운영
- 저작권 검증 (45개 소스 → 36개 선정)
...
- **10종 matplotlib 차트**: 기술적 지표/비교 시계열/백테스트/재무제표/밸류에이션/장중 시세/섹터 개요·상세·추이/가상투자 수익률
...
**📊 성과**
- 변환 정확도 **98.23%** (333/339) — 기존 **63% → 98.2%**
- 레거시 코드 **82% 감축** (3,229줄 → 570줄)
- **339개** 테스트 케이스 자동화, API 안정성 **100%**

**🔑 핵심 기술**
- LaTeX → BRF → Unicode 점자 **26단계** 변환 파이프라인
- 대규모 리팩터링 (가독성 + 유지보수성 개선)
...
**📊 성과**
- 서울시 **424개** 행정동 입지 분석 → **15개** 최적 입지 도출
- 최적 모델 **SVC** (F1=0.667, Accuracy=62.2%)
- 네이버 지도 리뷰 크롤링 + **12개** 공공데이터 활용

**🔑 핵심 기술**
- 매출 데이터 부재 극복을 위한 프록시 변수 설계
- PCA 차원 축소, 5-Fold Cross Validation
- 피처 중요도 분석으로 핵심 입지 요인 도출
...
**📊 성과**
- 전국 **2,072개** 행정동 × **38개** 농작물 토양 적합도 시각화
- **78,000개** 파라미터 대규모 배치 크롤링 (7시간)
